...
import com.wepindia.pos.adapters.TableBookingAdapter;
        ...
        if (crsrTBooking.moveToFirst()) {
            ...
            /*
               ...
               tvSno = new TextView(myContext);
                ...
                //   tviewTableNo.setGravity(Gravity.CENTER);
                ...
                //   tviewMobileNo.setGravity(Gravity.CENTER);
                ...
                tblTableBooking.addView(rowTBooking, new LayoutParams(LayoutParams.FILL_PARENT, LayoutParams.WRAP_CONTENT));
