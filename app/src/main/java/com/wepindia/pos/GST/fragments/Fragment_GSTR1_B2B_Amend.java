...
public class Fragment_GSTR1_B2B_Amend extends Fragment {
    Context myContext;
    DatabaseHandler dbAmmend_b2b_GSTR1;
    ...
    public Fragment_GSTR1_B2B_Amend() {}
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        try{
            dbAmmend_b2b_GSTR1 = new DatabaseHandler(getActivity());
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        // old fragment_fragment__gstr1__b2_b__amend
        View view = inflater.inflate(R.layout.test_fragment__gstr1__b2_b__amend, container, false);
        myContext = getActivity();
        MsgBox = new MessageDialog(myContext);
        try{
            dbAmmend_b2b_GSTR1.CloseDatabase();
            dbAmmend_b2b_GSTR1.CreateDatabase();
            dbAmmend_b2b_GSTR1.OpenDatabase();
    ...
    void InitializeViewVariables(View view)
    {
        ...
        et_gstin_ecom = (EditText) view.findViewById(R.id.et_gstin_ecom);
    ...
    {   try{
        ...
        Cursor cursor = dbAmmend_b2b_GSTR1.getAmmends_GSTR1_b2b(gstin, invoiceNo, String.valueOf(dd.getTime()));
        int count =1;
