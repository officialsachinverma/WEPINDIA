...
/**
 * Created by RakeshK on 7/27/2017.
 */
...
import com.wepindia.pos.PayBillActivity;
...
public class BillingCounterSalesActivity extends WepPrinterBaseActivity implements View.OnClickListener {
    ...
    private final static float mTextsize = 9;

    @Override
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        // TODO: 7/27/2017 activity_billing_counter_sales (prev)
        setContentView(R.layout.test_billing_counter_sales);
        ...
        if (crsrItem.moveToFirst() && crsrSettings.moveToFirst())
        {
            do {
                ...
                if (bItemExists == false) {
                    ...
                    tvName.setWidth(130); // 154px ~= 230dp
                    tvName.setTextSize(mTextsize);
                    ...
                    tvHSn.setWidth(55); // 154px ~= 230dp
                    tvHSn.setTextSize(mTextsize);
                    ...
                    etRate.setWidth(55); // 74px ~= 110dp
                    etRate.setTextSize(mTextsize);
                    ...
                    tvAmount.setWidth(80); // 97px ~= 145dp
                    tvAmount.setTextSize(mTextsize);
